...
.project-card--featured { grid-column: span 6; grid-row: span 2; }
.project-card--wide { grid-column: span 4; grid-row: span 1; }
.project-card--tall { grid-column: span 2; grid-row: span 2; }
.project-card--square { grid-column: span 2; grid-row: span 1; }
...
.project-card__overlay {
  ...
  transition:
    opacity var(--dur-short) var(--spring-gentle),
    transform var(--dur-short) var(--spring-gentle);
  pointer-events: none;
}
